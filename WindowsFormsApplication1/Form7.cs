...
namespace WindowsFormsApplication1
{
    public partial class Form7 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            mysql = "select * from  助学金信息表 where 学号='" + textBox1.Text.Trim() + "'";
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (dr == DialogResult.OK)
                    {
                        a3.Close();
                        string sql;
                        sql = "insert into 助学金信息表 values (" + "'" + textBox1.Text.Trim() + "','" + textBox2.Text.Trim() + "','" + textBox3.Text.Trim() + "','" + comboBox1.Text.Trim() + "','" + textBox4.Text.Trim() + "','" + textBox5.Text.Trim() + "', '" + textBox6.Text.Trim() + "','" + comboBox2.Text.Trim() + "','" + textBox8.Text.Trim() + "','" + textBox9.Text.Trim() + "','" + Program.Imagefile + "')";
                        a2.CommandText = sql;
                        a2.Connection = a1;
                        a2.ExecuteNonQuery();
