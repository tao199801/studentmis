...
namespace WindowsFormsApplication1
{
    public partial class Form13 : Form
    {
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            mysql = "select * from 奖学金评审表 where 学号='" + textBox1.Text.Trim() + "'";
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (dr == DialogResult.OK)
                    {
                        a3.Close();
                        string sql;
                        sql = "insert into 奖学金评审表 values (" + "'" + textBox1.Text.Trim() + "','" + textBox2.Text.Trim() + "','" + textBox3.Text.Trim() + "','" + comboBox1.Text.Trim() + "','" + textBox4.Text.Trim() + "','" + textBox5.Text.Trim() + "', '" + textBox6.Text.Trim() + "','" + comboBox2.Text.Trim() + "','" + textBox8.Text.Trim() + "','" + textBox9.Text.Trim() + "','" + comboBox3.Text.Trim() + "','" + textBox7.Text.Trim() + "')";
                        a2.CommandText = sql;
                        a2.Connection = a1;
                        a2.ExecuteNonQuery();
...
string wa;
            ...
            {
                wa = "select * from 奖学金信息表 where 学号='" + textBox1.Text.Trim() + "'";
                a2.CommandText = wa;
                a2.Connection = a1;
                OleDbDataReader a3 = a2.ExecuteReader();
                if (a3.Read() == false)
